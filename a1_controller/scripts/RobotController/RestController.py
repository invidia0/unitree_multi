...
class RestController(object):
    ...
    def updateStateCommand(self, msg, state, command):
        # local body position
        state.body_local_position[0] = 0.0 * 0.08
        state.body_local_position[1] = 0.0 * 0.08
        state.body_local_position[2] = 0.0 * 0.08

        # local body orientation
        state.body_local_orientation[0] = 0.0 * 0.8
        state.body_local_orientation[1] = 0.0 * 0.6
        state.body_local_orientation[2] = 0.0 * 0.6
